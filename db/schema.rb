...
ActiveRecord::Schema.define(version: 20160917144204) do
  ...
  create_table "attachment_references", force: :cascade do |t|
    ...
    t.datetime "created_at",      null: false
    t.datetime "updated_at",      null: false
    t.index ["attachment_id"], name: "index_attachment_references_on_attachment_id", using: :btree
    t.index ["user_id"], name: "index_attachment_references_on_user_id", using: :btree
  end
